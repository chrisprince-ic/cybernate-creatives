export default function Projects() {
  function learnMore() {
    alert('Projects releasing soon sorry for the wait');
  }

  return (
    <div
      id="projects"
      className="min-h-screen min-w-full relative overflow-hidden bg-veryLightGray"
    >
      <div className="h-full w-full">
        <svg
          className="absolute z-0 top-[-8%] left-[-46%] w-[150%] md:left-[-15%] md:w-[120%] md:top-[-16%] lg:left-[-5%] lg:top-[-20%] lg:w-[100%]"
          viewBox="0 0 2184.857 1664.516"
        >
          <defs>
      ...
      <div className="max-w-[30rem] h-full px-6 container mx-auto mb-16 flex flex-col space-y-8 pt-[70%] md:pt-[20%] md:mx-[10%]">
        <h2 className="text-3xl font-semiBold text-center nunito z-10 text-grayishLightWhite md:text-left">
          Projects Showcasing coming soon some are still under work
        </h2>

        <p className="z-10 nunito text-center text-darkGrayishLightWhiteOpac md:text-left">
          Sorry for the delay you can learn more about the kind of projects
          under work
        </p>
        <div className="flex justify-center md:justify-start">
          <button
            onClick={learnMore}
            className="z-10 py-2 px-3 font-bold bg-veryLightGreen text-black rounded-md hover:bg-lightGreenishSkyBlue"
          >
            Learn More
          </button>
        </div>
